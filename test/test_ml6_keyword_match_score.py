...
def main():
    parser = argparse.ArgumentParser(description="Calcule le ml6_keyword_match_score entre une annonce et un CV (PDFs).")
    ...
    result = ml6_keyword_match_score(model, offre_text, cv_text)
